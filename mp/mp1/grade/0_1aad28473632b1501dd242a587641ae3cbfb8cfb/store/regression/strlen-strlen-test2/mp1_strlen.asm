...
; This piece of code serves as the entry point to your STRLEN subroutine.
; The test string is stored at x2700, whose address is loaded into R0 before calling your subroutine.

.ORIG x3000

LD R0, KLC3_TEST_STRING_ADDR
JSR STRLEN
