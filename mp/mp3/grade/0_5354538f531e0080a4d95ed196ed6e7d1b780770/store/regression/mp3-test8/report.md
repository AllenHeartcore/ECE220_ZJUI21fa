...
**NOTE**: in [test0](test0), at step 1115, writing to unspecified addr x4000.
...
**NOTE**: in [test0](test0), at step 1524, writing to unspecified addr x4049.

<br><br>

:warning: **WARNING**: write to uninitialized memory at [[mp3.asm:139](mp3.asm#L139)] `STR	R0, R5, #2`.

**NOTE**: in [test0](test0), at step 1527, writing to unspecified addr x404A.

<br><br>

:warning: **WARNING**: write to uninitialized memory at [[mp3.asm:169](mp3.asm#L169)] `STR	R1, R5, #0`.

**NOTE**: in [test0](test0), at step 1546, writing to unspecified addr x4048.
